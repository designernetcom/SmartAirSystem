...
// ------------ Gallery Page  End-----------------
    ...
    // Open modal when clicking on any thumbnail
    thumbnails.forEach((thumbnail) => {
      thumbnail.addEventListener('click', () => {
        modalImage.src = thumbnail.src; // Set modal image source to clicked thumbnail's source
...
// ------------ Gallery Page End -----------------
 ...
 document.addEventListener("DOMContentLoaded", function () {
    const subMenuItems = document.querySelectorAll(".submenu ul li");

    subMenuItems.forEach((item) => {
        item.addEventListener("click", (e) => {
            e.stopPropagation(); // Prevent click event bubbling

            // Toggle the visibility of the nested submenu
            const nestedMenu = item.querySelector("ul");
            if (nestedMenu) {
